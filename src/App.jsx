...
function AppContent() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      <Toaster />
      <header className="sticky top-0 z-50 shadow-md backdrop-blur-md" style={{ backgroundColor: '#028598' }} dir="rtl">
...
احجز الآن
      ...
      <CountdownTimer 
        message="احجز استشارة واحصل على جلسة مجانية! العرض ينتهي قريباً. أماكن محدودة متاحة." 
      />
