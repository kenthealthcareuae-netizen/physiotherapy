    ...
    try {
      ...
      await emailjs.send(
        ...
        emailjsConfig.templateId,
        {
          ...
          phone: formData.phone.trim(),
          email: 'N/A',
          subject: 'WhatsApp Lead - Form Submission',
          message: `FORM METHOD: WhatsApp Gateway
...
Timestamp: ${new Date().toLocaleString('en-US', { timeZone: 'Asia/Dubai' })}`,
      ...
      toast({
        ...
        description: 'سيتم توجيهك إلى WhatsApp...'
      });

      // Create WhatsApp message with pre-filled text
      const message = `مرحباً، أنا ${formData.name.trim()}. أريد الاستفسار عن خدمات العلاج الطبيعي.`;
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-gray-900">ابدأ المحادثة على WhatsApp</h2>
          </div>
          <Button
            variant="ghost"
            size="sm"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            <p className="text-sm text-blue-800">
              <strong>ملاحظة:</strong> بعد إرسال البيانات، سيتم توجيهك تلقائياً إلى WhatsApp لبدء المحادثة.
            </p>
          </div>
          ...
          <div className="flex gap-3 pt-4">
            ...
            >
              {isSubmitting ? 'جاري الإرسال...' : 'ابدأ المحادثة'}
            </Button>
          </div>
        </form>
      </div>
