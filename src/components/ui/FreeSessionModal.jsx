  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name.trim() || !formData.phone.trim() || !formData.problem.trim()) {
      toast({
        ...
        description: 'الاسم ورقم الهاتف ووصف المشكلة مطلوبة',
        variant: 'destructive'
      });
      return;
    }
    ...
    try {
      ...
      await emailjs.send(
        ...
        emailjsConfig.templateId,
        {
          ...
          phone: formData.phone.trim(),
          email: 'N/A',
          subject: 'Free Session Request - Popup Form',
          message: `FORM METHOD: Free Session Popup
...
Timestamp: ${new Date().toLocaleString('en-US', { timeZone: 'Asia/Dubai' })}`,
      ...
      toast({
        ...
        description: 'سيتم التواصل معك خلال 24 ساعة لحجز جلستك المجانية'
      });
        ...
        <div className="relative">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">جلسة مجانية! 🎁</h2>
                <p className="text-sm text-gray-600">احصل على استشارة مجانية</p>
              </div>
            </div>
            <Button
              variant="ghost"
          ...
          <div className="bg-gradient-to-r from-green-50 to-blue-50 p-4 rounded-lg mb-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-bold text-gray-800">ماذا ستحصل عليه؟</span>
            </div>
            <ul className="space-y-2 text-sm text-gray-700">
              <li className="flex items-center gap-2">
                <Heart className="w-4 h-4 text-red-500" />
                <span>تقييم شامل لحالتك الصحية</span>
              </li>
              <li className="flex items-center gap-2">
                <Sparkles className="w-4 h-4 text-purple-500" />
                <span>خطة علاج مخصصة لك</span>
              </li>
              <li className="flex items-center gap-2">
                <Gift className="w-4 h-4 text-green-500" />
                <span>نصائح وإرشادات مجانية</span>
              </li>
            </ul>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={handleInputChange}
                placeholder="أخبرنا عن المشكلة الصحية التي تواجهها..."
                required
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <p className="text-sm text-blue-800">
                <strong>✨ مضمون:</strong> جلسة مجانية 100% بدون أي التزامات مالية
              </p>
            </div>
            ...
            <div className="flex gap-3 pt-4">
              ...
              >
                {isSubmitting ? 'جاري الإرسال...' : 'احجز جلستي المجانية 🎁'}
              </Button>
            </div>
          </form>
        </div>
