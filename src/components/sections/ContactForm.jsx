    ...
    try {
      ...
      await emailjs.send(
        ...
        emailjsConfig.templateId,
        {
          ...
          subject: 'Lead from Physiotherapy Landing Page',
          message: `FORM METHOD: Contact Form
...
Timestamp: ${new Date().toLocaleString('en-US', { timeZone: 'Asia/Dubai' })}`,
  ...
  return (
    <section id="contact" className="py-16 md:py-24 bg-background" dir="rtl">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle dir="rtl">تواصل معنا واحجز جلستك</SectionTitle>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-stretch">
          ...
          >
            <h3 className="text-2xl font-semibold text-primary mb-6" dir="rtl">معلومات الاتصال</h3>
            <div className="space-y-4 flex-grow">
              <a href="tel:+971507547326" className="flex items-center space-x-reverse space-x-3 group">
              ...
              <a href="mailto:info@kenthealthcare.ae" className="flex items-center space-x-reverse space-x-3 group">
              ...
              <div className="flex items-center space-x-reverse space-x-3">
                ...
                <a 
                  ...
                  dir="rtl"
                >
                  كنت للرعاية الصحية، مبنى نشوان – 208C شارع المنخول – فوق بنك الإمارات دبي الوطني – الرفاع – دبي<br />
                  صندوق البريد – 123657
                </a>
              </div>
            </div>
            <div className="pt-6 border-t border-border">
              <h3 className="text-xl font-semibold text-primary mb-4" dir="rtl">ساعات العمل</h3>
              <p className="text-foreground" dir="rtl">الاثنين – السبت: 9:00 صباحاً – 8:00 مساءً</p>
              <p className="text-foreground" dir="rtl">الأحد: 9:00 صباحاً – 8:00 مساءً</p>
            </div>
          </motion.div>
          ...
          >
            <h3 className="text-2xl font-semibold text-primary mb-6" dir="rtl">نموذج الحجز السريع</h3>
            <div className="flex-grow space-y-4">
              <div>
                <Label htmlFor="name" className="mb-1 block text-sm font-medium text-foreground" dir="rtl">
                  الاسم الكامل*
                </Label>
                <Input
                  type="text"
              ...
              <div>
                <Label htmlFor="phone" className="mb-1 block text-sm font-medium text-foreground" dir="rtl">
                  رقم الهاتف*
                </Label>
                <Input
                  type="tel"
              ...
              <div>
                <Label htmlFor="email" className="mb-1 block text-sm font-medium text-foreground" dir="rtl">
              ...
              <div>
                <Label htmlFor="message" className="mb-1 block text-sm font-medium text-foreground" dir="rtl">
                ...
                <ShadcnTextarea
                  ...
                  onChange={handleChange}
                  placeholder="أي تفضيلات أو أسئلة؟"
                  dir="rtl"
                  rows={3}
                  disabled={isSubmitting}
                />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-primary mb-4" dir="rtl">موقعنا</h2>
              <p className="text-lg text-muted-foreground" dir="rtl">قم بزيارة عيادتنا في قلب دبي</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center md:text-left">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-4" dir="rtl">كنت للرعاية الصحية</h3>
                  <p className="text-gray-600 mb-6 leading-relaxed" dir="rtl">
                    مبنى نشوان – 208C شارع المنخول<br />
                    فوق بنك الإمارات دبي الوطني – الرفاع – دبي<br />
                    صندوق البريد – 123657
                  </p>
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    <div className="text-center text-white">
                      ...
                      <p className="text-xl font-bold" dir="rtl">انقر للفتح في خرائط جوجل</p>
                    </div>
                  </div>
                </a>
              </div>
