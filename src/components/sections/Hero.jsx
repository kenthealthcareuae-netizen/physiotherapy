...
// Two-step form content with progress indicator
      ...
      try {
        ...
        await emailjs.send(
          ...
          { 
            ...
            subject: 'Lead from Hero Form - Step 1 Complete',
            message: `FORM METHOD: Hero Quick Booking - Step 1 Complete
...
Timestamp: ${new Date().toLocaleString('en-US', { timeZone: 'Asia/Dubai' })}`,
      ...
      toast({ title:'خطأ في البيانات', description:'الاسم ورقم الهاتف مطلوبان.', variant:'destructive' })
    }
  }
  ...
  return (
    <div className="space-y-4 p-6 bg-card rounded-lg shadow-xl border border-primary/10">
      ...
      <div className="flex items-center justify-center mb-6">
        ...
        <span className="mr-4 text-sm font-medium text-gray-600" dir="rtl">
          {currentStep}/2
        </span>
      </div>

      <h3 className="text-2xl font-semibold text-primary text-center" dir="rtl">
        {currentStep === 1 ? 'البيانات الأساسية' : 'تفاصيل إضافية'}
      </h3>
      ...
      {currentStep === 1 ? (
        <div className="space-y-4">
          ...
          <Button
            ...
            size="lg"
            className="w-full bg-primary text-white py-3 font-bold uppercase tracking-wide"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <Label htmlFor="message" className="block text-sm mb-1" dir="rtl">
              أخبرنا بالمشكلة الصحية إذا أردت (اختياري)
            </Label>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <p className="text-sm text-blue-800 text-center" dir="rtl">
              نحترم خصوصيتك – جميع المعلومات سرية ومحمية
            </p>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <Button
              type="submit"
              size="lg"
              className="flex-1 bg-primary text-white py-3 font-bold uppercase tracking-wide"
              disabled={isSubmitting}
            >
            ...
            <div className="lg:col-span-7" dir="rtl">
              <AnimatePresence mode="wait">
                {showForm ? (
                  ...
                  >
                    <h1 className="text-5xl md:text-7xl font-extrabold mb-10 text-center lg:text-right leading-tight" dir="rtl">
                      <span className="block text-primary mb-2">استعد استقلالك وثقتك</span>
                      <span className="block gradient-text-alt text-4xl md:text-6xl">مع العلاج الطبيعي المتخصص</span>
                    </h1>
                    <p className="text-xl md:text-2xl text-muted-foreground mb-16 max-w-3xl mx-auto lg:mr-0 leading-relaxed font-medium" dir="rtl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center lg:justify-start mb-10" dir="rtl">
                      ...
                      >
                        <ArrowRight className="mr-3 h-6 w-6"/> احجز جلستك المجانية
                      </Button>
                    ...
                    <div className="flex flex-col items-center lg:items-start mt-8">
                      <Button size="md" variant="ghost" className="text-primary hover:text-accent underline font-bold uppercase tracking-wide mb-4" asChild>
                        <a href="#services" dir="rtl">استكشف خدماتنا ←</a>
                      </Button>
                      {/* Scrolling Cue */}
                      <div className="flex flex-col items-center animate-bounce">
                        <span className="text-sm text-muted-foreground mb-2" dir="rtl">اكتشف المزيد</span>
